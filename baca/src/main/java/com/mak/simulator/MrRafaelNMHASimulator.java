...
public class MrRafaelNMHASimulator extends AbstractBacaSimulator {
	...
	public MrRafaelNMHASimulator(int stopLoss, int stopWin, List<Integer> betSpreads, int betIndex) {
	...
	public static void main(String args[]) {
		...
		MrRafaelNMHASimulator sim = new MrRafaelNMHASimulator(-240, 15, Arrays.asList(1,1,1,1,1,1,1,5,5,10,10,15,20,25,35,45,60), -1);
		sim.prepareGame(78);
		sim.beginSimulation();
