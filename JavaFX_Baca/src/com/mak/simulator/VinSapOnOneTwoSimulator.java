...
public class VinSapOnOneTwoSimulator extends AbstractBacaSimulator implements BacaSystemSimulator {
	...
	public static void main(String[] args) {
		...
		for(int i=1; true; i++){
			VinSapOnOneTwoSimulator sim = new VinSapOnOneTwoSimulator();
			sim.prepareGame(78);
			sim.beginSimulation();
	...
	public VinSapOnOneTwoSimulator(){
