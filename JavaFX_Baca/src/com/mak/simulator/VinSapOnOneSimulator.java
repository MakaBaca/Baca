...
public class VinSapOnOneSimulator extends AbstractBacaSimulator implements BacaSystemSimulator {
	...
	public static void main(String[] args) {
		...
		for(int i=1; true; i++){
			VinSapOnOneSimulator sim = new VinSapOnOneSimulator();
			sim.prepareGame(78);
			sim.beginSimulation();
			...
			if(unitsWon >=15 || holdingUnits <= 0 || holdingUnits < sim.stopLoss || (i >5 && unitsWon > 0)){
